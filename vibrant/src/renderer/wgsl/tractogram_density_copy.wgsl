@group(0) @binding(0) var<storage, read> BUFFER: array<array<array<u32, VOLUME_XYZ>, VOLUME_XYZ>, VOLUME_XYZ>;
@group(0) @binding(1) var TEXTURE: texture_storage_3d<r32float, write>;
